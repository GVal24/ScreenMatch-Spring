...
import com.aluracursos.screenmatch.DatosSerie;
...
public class Principal {
    ...
    private final String API_KEY = "&apikey=7ec7bcba";
...
//        }
       ...
       // temporadas.forEach(t -> t.episodios().forEach(e -> System.out.println(e.titulo())));
        ...
        //Convertir todas las funciones a una lista del tipo DatosEpisodio
